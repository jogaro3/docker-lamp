            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container justify-content-between">
                    <?php
                        ...
                        // Verificar rol (debe ser 0 o 1)
                        if ($rol !== '0' && $rol !== '1') {
                            $error = true;
                            echo '<div class="alert alert-danger" role="alert">El campo rol es obligatorio y debe ser 0 (Normal) o 1 (Administrador).</div>';
                        }

                        if (!$error) {
                            require_once('../modelo/pdo.php');
                            $resultado = nuevoUsuario(filtraCampo($nombre), filtraCampo($apellidos), filtraCampo($username), $contrasena, $rol); // Asegúrate de pasar el rol
                            if ($resultado[0]) {
